...
btn_clique_ativar = tk.Button(janela, text="Clique Aqui :) ", font=("Arial", 14), bg="#e6dd61", fg="black", command=mostrar_mensagem )
btn_clicar_fechar = tk.Button(janela, text="Fechar Aplicativo", font=("Arial", 14), bg="#124b41", fg="white", command=mostrar_mensagem )
